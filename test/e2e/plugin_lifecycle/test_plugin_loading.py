...
class TestBasicPluginLoading:
    ...
    @pytest.mark.asyncio
    async def test_plugin_loads_successfully(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试插件能够成功加载"""
    ...
    @pytest.mark.asyncio
    async def test_init_hook_called(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试 _init_ 钩子被调用"""
    ...
    @pytest.mark.asyncio
    async def test_on_load_hook_called(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试 on_load 钩子被调用"""
        await test_suite.register_plugin(basic_plugin_name)
        BasicTestPlugin = get_plugin_class(basic_plugin_name)
    ...
    @pytest.mark.asyncio
    async def test_plugin_in_loader_registry(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试插件被注册到加载器中"""
        await test_suite.register_plugin(basic_plugin_name)
    ...
    @pytest.mark.asyncio
    async def test_plugin_can_be_retrieved(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试可以通过名称获取插件"""
        await test_suite.register_plugin(basic_plugin_name)
...
class TestPluginLoadingWithCommands:
    ...
    @pytest.mark.asyncio
    async def test_commands_registered_on_load(self, test_suite: E2ETestSuite, command_plugin_name):
        """测试命令在加载时被注册"""
    ...
    @pytest.mark.asyncio
    async def test_command_aliases_registered(self, test_suite: E2ETestSuite, command_plugin_name):
        """测试命令别名被注册"""
        await test_suite.register_plugin(command_plugin_name)
    ...
    @pytest.mark.asyncio
    async def test_command_executable_after_load(self, test_suite: E2ETestSuite, command_plugin_name):
        """测试加载后命令可执行"""
        await test_suite.register_plugin(command_plugin_name)
...
class TestPluginLoadingWithConfig:
    ...
    @pytest.mark.asyncio
    async def test_configs_registered_on_load(self, test_suite: E2ETestSuite, config_plugin_name):
        """测试配置在加载时被注册"""
    ...
    @pytest.mark.asyncio
    async def test_config_defaults_applied(self, test_suite: E2ETestSuite, config_plugin_name):
        """测试配置默认值被应用"""
        await test_suite.register_plugin(config_plugin_name)
    ...
    @pytest.mark.asyncio
    async def test_config_accessible_via_plugin(self, test_suite: E2ETestSuite, config_plugin_name):
        """测试配置可通过插件实例访问"""
...
class TestPluginLoadingWithHandlers:
    ...
    @pytest.mark.asyncio
    async def test_handlers_registered_on_load(self, test_suite: E2ETestSuite, handler_plugin_name):
        """测试事件处理器在加载时被注册"""
    ...
    @pytest.mark.asyncio
    async def test_message_handler_receives_events(self, test_suite: E2ETestSuite, handler_plugin_name):
        """测试消息处理器能接收事件"""
...
class TestFullFeaturePluginLoading:
    ...
    @pytest.mark.asyncio
    async def test_full_lifecycle_hooks(self, test_suite: E2ETestSuite, full_feature_plugin_name):
        """测试完整生命周期钩子"""
    ...
    @pytest.mark.asyncio
    async def test_all_services_initialized(self, test_suite: E2ETestSuite, full_feature_plugin_name):
        """测试所有服务都被初始化"""
    ...
    @pytest.mark.asyncio
    async def test_integrated_command_execution(self, test_suite: E2ETestSuite, full_feature_plugin_name):
        """测试集成命令执行"""
        await test_suite.register_plugin(full_feature_plugin_name)
        FullFeaturePlugin = get_plugin_class(full_feature_plugin_name)
...
class TestMultiplePluginLoading:
    ...
    @pytest.mark.asyncio
    async def test_load_multiple_plugins(
        self, test_suite: E2ETestSuite, basic_plugin_name, command_plugin_name
    ):
        """测试加载多个插件"""
        await test_suite.register_plugin(basic_plugin_name)
        await test_suite.register_plugin(command_plugin_name)
    ...
    @pytest.mark.asyncio
    async def test_plugins_dont_interfere(
