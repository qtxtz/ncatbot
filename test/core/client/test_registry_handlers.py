...
class TestEventRegistryMessageHandlers:
    ...
    @pytest.mark.asyncio
    async def test_add_group_message_handler(self, event_registry, mock_group_message_event):
        """群消息处理器注册及过滤"""
        received = []
    ...
    @pytest.mark.asyncio
    async def test_add_group_message_handler_filters_private(self, event_registry, mock_private_message_event):
        """群消息处理器过滤私聊消息"""
        received = []
    ...
    @pytest.mark.asyncio
    async def test_add_private_message_handler(self, event_registry, mock_private_message_event):
        """私聊消息处理器注册及过滤"""
        received = []
    ...
    @pytest.mark.asyncio
    async def test_add_private_message_handler_filters_group(self, event_registry, mock_group_message_event):
        """私聊消息处理器过滤群消息"""
        received = []
...
class TestEventRegistryRequestHandlers:
    ...
    @pytest.mark.asyncio
    async def test_add_group_request_handler(self, event_registry, mock_group_request_event):
        """群请求处理器"""
        received = []
    ...
    @pytest.mark.asyncio
    async def test_add_friend_request_handler(self, event_registry, mock_friend_request_event):
        """好友请求处理器"""
        received = []
    ...
    @pytest.mark.asyncio
    async def test_add_group_request_handler_filters_friend(self, event_registry, mock_friend_request_event):
        """群请求处理器过滤好友请求"""
        received = []
...
class TestEventRegistryMetaHandlers:
    ...
    @pytest.mark.asyncio
    async def test_add_startup_handler_filters_heartbeat(self, event_registry, mock_heartbeat_event):
        """启动处理器过滤心跳事件"""
        received = []
