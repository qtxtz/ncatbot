        ...
        for event_data in data_provider.all_events:
            try:
                ...
                failures.append({
                    ...
                    "secondary": event_data.get("message_type") or 
                                event_data.get("notice_type") or 
                                event_data.get("meta_event_type")
                })
    ...
    def test_event_statistics(self, data_provider):
        ...
        for event in data_provider.all_events:
            ...
            secondary = (
                ...
                event.get("notice_type") or
                event.get("meta_event_type") or
...
class TestEdgeCases:
    ...
    def test_large_message_array(self, mock_api):
        """测试大消息数组"""
        segments = [{"type": "text", "data": {"text": f"segment_{i}"}} for i in range(100)]
