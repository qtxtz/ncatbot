...
from ncatbot_legacy.core import EventBus, NcatBotEvent
from ncatbot_legacy.core.service import ServiceManager

if TYPE_CHECKING:
    from .builtin_mixin.ncatbot_plugin import NcatBotPlugin
    from ncatbot_legacy.core.service.builtin import (
        RBACService,
        PluginConfigService,
        PluginConfig,
    )
    from ncatbot_legacy.core.api.interface import IBotAPI
